...
import static code.TheBalatro.Enums.BALATRO_COLOR;

import static code.TheBalatroMod.*;

public class TheBalatro extends CustomPlayer {

    static final String ID = makeID("TheBalatro");
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;

    public PokerDeck PokerDeck = new PokerDeck();



    public TheBalatro(String name, PlayerClass setClass) {
    ...
    public void doCharSelectScreenSelectEffect() {
        CardCrawlGame.sound.playA("CARD_SELECT", MathUtils.random(-0.2F, 0.2F));
    ...
    public AbstractPlayer newInstance() {
        TheBalatro newPlayer = new TheBalatro(this.name, TheBalatro.Enums.THE_BALATRO);
        newPlayer.PokerDeck = new PokerDeck();
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_BALATRO;
        @SpireEnum(name = "BALATRO_COLOR")
        public static AbstractCard.CardColor BALATRO_COLOR;
        @SpireEnum(name = "BALATRO_COLOR")
